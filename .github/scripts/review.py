...
def get_pr_diff():
    url = f"https://api.github/cmo/repos{REPO}/pulls/{PR_NUMBER}"
    headers = {
...
def review_with_groq(diff):
    prompt = f""" Your are an expert coder reviewer. Review this git diff:
1. **Summary** - what changed
2. **Issues** - bugs, secuirty problems, bad practices
